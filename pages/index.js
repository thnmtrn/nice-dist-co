  ...
  return (
    <>
      ...
      <div className="w-full">
        <Head>
          <title>Nice Dist Co</title>
          <meta name="description" content="Nice Dist Co shop. under construction" />
          <meta property="og:title" content="Nice Dist Co" key="title" />
        </Head>
      ...
      <div className="pt-10 pb-6 flex flex-col items-center">
        ...
        <p className="text-gray-600 text-sm">Best premium beauty products</p>
      </div>
