  ...
  return (
    <>
      <div className="w-full">
        <CartLink />
        <Head>
          <title>Nice Dist Co - All Categories</title>
          <meta name="description" content={`Nice Dist Co - All categories`} />
          <meta property="og:title" content="Nice Dist Co - All Categories" key="title" />
        </Head>
        <div className="
          pt-4 sm:pt-10 pb-8
        ">
